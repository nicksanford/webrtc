...
// This shows that OnTrack is not guranteed to be called if AddTrack is called imediately after the peer connection is established
// run `go test -v -race -run TestOnTrackCalledAfterPeerConnectionEstablished -count 100 --failfast` to repro
func TestOnTrackCalledAfterPeerConnectionEstablished(t *testing.T) {
	var (
...
// This shows that OnTrack is not guranteed to be called if AddTrack is called and only a single RTP packet is sent
// go test -run=TestOnTrackCalledIfNoRTPPacketsSent
func TestOnTrackCalledAfterSinglePacketSend(t *testing.T) {
	var (
		clientNegChannelOpened <-chan struct{}
		clientNegChannelClosed <-chan struct{}
		serverNegChannelOpened <-chan struct{}
...
// This shows that OnTrack is not guranteed to be called if AddTrack is called and no RTP packet is sent
// go test -run=TestOnTrackCalledIfNoRTPPacketsSent
func TestOnTrackCalledIfNoRTPPacketsSent(t *testing.T) {
	var (
		clientNegChannelOpened <-chan struct{}
		clientNegChannelClosed <-chan struct{}
		serverNegChannelOpened <-chan struct{}
...
// This shows that OnTrack is not guranteed to be called if AddTrack is called and RemoveTrack is called and no RTP packet is sent
// go test -run=TestOnTrackCalledIfRemoveTrackCalledAfterAddTrack
func TestOnTrackCalledIfRemoveTrackCalledAfterAddTrack(t *testing.T) {
	var (
		clientNegChannelOpened <-chan struct{}
		clientNegChannelClosed <-chan struct{}
		serverNegChannelOpened <-chan struct{}
